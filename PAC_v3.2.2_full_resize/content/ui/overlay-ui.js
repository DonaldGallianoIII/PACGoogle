/**
 * PAC Live Data Calculator - UI Components
 *
 * Main overlay UI, panels, and interaction handlers.
 * Uses the PAC namespace for data, utilities, state, and calculations.
 */
(function() {
  'use strict';
  ...
  // Local runtime variables (shared with namespace)
  ...
  // Sync local vars with State namespace
  function syncToState() {
    State.extractionInterval = extractionInterval;
    State.isMinimized = isMinimized;
    State.currentPollSpeed = currentPollSpeed;
    State.liveTrackingActive = liveTrackingActive;
    State.isConnected = isConnected;
    State.lastPoolData = lastPoolData;
    State.lastCurrentHash = lastCurrentHash;
    State.lastTeamFingerprint = lastTeamFingerprint;
  }
  ...
  if (PAC.DEBUG_MODE) {
    console.log('PAC UI: Overlay components loaded');
  }
})();
